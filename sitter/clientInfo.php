...
<title> View Report - PSIRT Sitter Dashboard </title>
    ...
    ?>
            ...
            <div class="comments">
                ...
                if ($orderRow['state'] === 'assigned') {
                    echo '<button type="button" onclick="markOrderPending()">Mark as Pending</button>';
                }
                ?>
            </div>
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    if (response.success) {
                        ...
                        alert('Error marking order as pending: ' + response.error);
                    }
                }
            };
